                ...
                <div>
                    <form onSubmit={handleAddTask}>
                        <div className="grid place-items-center p-10">
                            <input className="border p-2 w-full max-w-lg focus:outline-none focus:ring rounded-lg" 
                            value={inputValue} 
                    ...
                    <div className="h-80 mx-2 overflow-y-auto">
                        ...
                        >
                        <div className="task w-full flex justify-between items-center shadow-current shadow-sm max-w-lg p-2 rounded-lg">
